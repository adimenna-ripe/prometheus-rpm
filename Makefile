...
publish9: sign9
	for i in _dist9/*.rpm; do cloudsmith push rpm adimenna-ripe/prometheus-rpm/el/9 $i -k ${CLOUDSMITH_TOKEN}; done

publish8: sign8
	for i in _dist8/*.rpm; do cloudsmith push rpm adimenna-ripe/prometheus-rpm/el/8 $i -k ${CLOUDSMITH_TOKEN}; done
